...
func (_q *BotQuery) Where(ps ...predicate.Bot) *BotQuery {
	_q.predicates = append(_q.predicates, ps...)
	return _q
}

// Limit the number of records to be returned by this query.
func (_q *BotQuery) Limit(limit int) *BotQuery {
	_q.ctx.Limit = &limit
	return _q
}

// Offset to start from.
func (_q *BotQuery) Offset(offset int) *BotQuery {
...
func (_q *BotQuery) Unique(unique bool) *BotQuery {
	_q.ctx.Unique = &unique
	return _q
}

// Order specifies how the records should be ordered.
func (_q *BotQuery) Order(o ...bot.OrderOption) *BotQuery {
	_q.order = append(_q.order, o...)
	return _q
}

// QueryExchange chains the current query on the "exchange" edge.
func (_q *BotQuery) QueryExchange() *ExchangeQuery {
...
func (_q *BotQuery) QueryStrategy() *StrategyQuery {
...
func (_q *BotQuery) QueryRunner() *BotRunnerQuery {
...
func (_q *BotQuery) QueryTrades() *TradeQuery {
...
func (_q *BotQuery) First(ctx context.Context) (*Bot, error) {
...
func (_q *BotQuery) FirstX(ctx context.Context) *Bot {
...
func (_q *BotQuery) FirstID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *BotQuery) FirstIDX(ctx context.Context) uuid.UUID {
...
func (_q *BotQuery) Only(ctx context.Context) (*Bot, error) {
...
func (_q *BotQuery) OnlyX(ctx context.Context) *Bot {
...
func (_q *BotQuery) OnlyID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *BotQuery) OnlyIDX(ctx context.Context) uuid.UUID {
...
func (_q *BotQuery) All(ctx context.Context) ([]*Bot, error) {
	ctx = setContextOp(ctx, _q.ctx, ent.OpQueryAll)
	if err := _q.prepareQuery(ctx); err != nil {
		return nil, err
	}
	qr := querierAll[[]*Bot, *BotQuery]()
	return withInterceptors[[]*Bot](ctx, _q, qr, _q.inters)
}

// AllX is like All, but panics if an error occurs.
func (_q *BotQuery) AllX(ctx context.Context) []*Bot {
...
func (_q *BotQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
	if _q.ctx.Unique == nil && _q.path != nil {
		_q.Unique(true)
	}
	ctx = setContextOp(ctx, _q.ctx, ent.OpQueryIDs)
	if err = _q.Select(bot.FieldID).Scan(ctx, &ids); err != nil {
		return nil, err
	}
	return ids, nil
}
...
func (_q *BotQuery) IDsX(ctx context.Context) []uuid.UUID {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *BotQuery) Count(ctx context.Context) (int, error) {
	ctx = setContextOp(ctx, _q.ctx, ent.OpQueryCount)
	if err := _q.prepareQuery(ctx); err != nil {
		return 0, err
	}
	return withInterceptors[int](ctx, _q, querierCount[*BotQuery](), _q.inters)
}

// CountX is like Count, but panics if an error occurs.
func (_q *BotQuery) CountX(ctx context.Context) int {
...
func (_q *BotQuery) Exist(ctx context.Context) (bool, error) {
...
func (_q *BotQuery) ExistX(ctx context.Context) bool {
...
func (_q *BotQuery) Clone() *BotQuery {
	if _q == nil {
		return nil
	}
	return &BotQuery{
		config:       _q.config,
		ctx:          _q.ctx.Clone(),
		order:        append([]bot.OrderOption{}, _q.order...),
...
func (_q *BotQuery) WithExchange(opts ...func(*ExchangeQuery)) *BotQuery {
	query := (&ExchangeClient{config: _q.config}).Query()
...
func (_q *BotQuery) WithStrategy(opts ...func(*StrategyQuery)) *BotQuery {
	query := (&StrategyClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *BotQuery) WithRunner(opts ...func(*BotRunnerQuery)) *BotQuery {
	query := (&BotRunnerClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *BotQuery) WithTrades(opts ...func(*TradeQuery)) *BotQuery {
	query := (&TradeClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *BotQuery) Aggregate(fns ...AggregateFunc) *BotSelect {
	return _q.Select().Aggregate(fns...)
}

func (_q *BotQuery) prepareQuery(ctx context.Context) error {
...
func (_q *BotQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Bot, error) {
	var (
		nodes       = []*Bot{}
		_spec       = _q.querySpec()
		loadedTypes = [4]bool{
	...
	if query := _q.withExchange; query != nil {
		if err := _q.loadExchange(ctx, query, nodes, nil,
			func(n *Bot, e *Exchange) { n.Edges.Exchange = e }); err != nil {
			return nil, err
		}
	}
	...
	if query := _q.withRunner; query != nil {
		if err := _q.loadRunner(ctx, query, nodes, nil,
			func(n *Bot, e *BotRunner) { n.Edges.Runner = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withTrades; query != nil {
	...
	for name, query := range _q.withNamedTrades {
		if err := _q.loadTrades(ctx, query, nodes,
			func(n *Bot) { n.appendNamedTrades(name) },
			func(n *Bot, e *Trade) { n.appendNamedTrades(name, e) }); err != nil {
			return nil, err
		}
	}
...
func (_q *BotQuery) loadExchange(ctx context.Context, query *ExchangeQuery, nodes []*Bot, init func(*Bot), assign func(*Bot, *Exchange)) error {
...
func (_q *BotQuery) loadStrategy(ctx context.Context, query *StrategyQuery, nodes []*Bot, init func(*Bot), assign func(*Bot, *Strategy)) error {
	ids := make([]uuid.UUID, 0, len(nodes))
	nodeids := make(map[uuid.UUID][]*Bot)
	for i := range nodes {
...
func (_q *BotQuery) loadRunner(ctx context.Context, query *BotRunnerQuery, nodes []*Bot, init func(*Bot), assign func(*Bot, *BotRunner)) error {
	ids := make([]uuid.UUID, 0, len(nodes))
	nodeids := make(map[uuid.UUID][]*Bot)
	for i := range nodes {
		fk := nodes[i].RunnerID
...
func (_q *BotQuery) loadTrades(ctx context.Context, query *TradeQuery, nodes []*Bot, init func(*Bot), assign func(*Bot, *Trade)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(trade.FieldBotID)
	}
...
func (_q *BotQuery) sqlCount(ctx context.Context) (int, error) {
	_spec := _q.querySpec()
	if len(_q.modifiers) > 0 {
		_spec.Modifiers = _q.modifiers
	}
...
func (_q *BotQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withExchange != nil {
			_spec.Node.AddColumnOnce(bot.FieldExchangeID)
		}
		if _q.withStrategy != nil {
			_spec.Node.AddColumnOnce(bot.FieldStrategyID)
		}
		if _q.withRunner != nil {
			_spec.Node.AddColumnOnce(bot.FieldRunnerID)
		}
	}
...
func (_q *BotQuery) sqlQuery(ctx context.Context) *sql.Selector {
...
// WithNamedTrades tells the query-builder to eager-load the nodes that are connected to the "trades"
// edge with the given name. The optional arguments are used to configure the query builder of the edge.
func (_q *BotQuery) WithNamedTrades(name string, opts ...func(*TradeQuery)) *BotQuery {
	query := (&TradeClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	if _q.withNamedTrades == nil {
		_q.withNamedTrades = make(map[string]*TradeQuery)
	}
	_q.withNamedTrades[name] = query
	return _q
}
...
func (_g *BotGroupBy) Aggregate(fns ...AggregateFunc) *BotGroupBy {
	_g.fns = append(_g.fns, fns...)
	return _g
}

// Scan applies the selector query and scans the result into the given value.
func (_g *BotGroupBy) Scan(ctx context.Context, v any) error {
	ctx = setContextOp(ctx, _g.build.ctx, ent.OpQueryGroupBy)
	if err := _g.build.prepareQuery(ctx); err != nil {
		return err
	}
	return scanWithInterceptors[*BotQuery, *BotGroupBy](ctx, _g.build, _g, _g.build.inters, v)
}

func (_g *BotGroupBy) sqlScan(ctx context.Context, root *BotQuery, v any) error {
...
func (_s *BotSelect) Aggregate(fns ...AggregateFunc) *BotSelect {
	_s.fns = append(_s.fns, fns...)
	return _s
}

// Scan applies the selector query and scans the result into the given value.
func (_s *BotSelect) Scan(ctx context.Context, v any) error {
	ctx = setContextOp(ctx, _s.ctx, ent.OpQuerySelect)
	if err := _s.prepareQuery(ctx); err != nil {
		return err
	}
	return scanWithInterceptors[*BotQuery, *BotSelect](ctx, _s.BotQuery, _s, _s.inters, v)
}

func (_s *BotSelect) sqlScan(ctx context.Context, root *BotQuery, v any) error {
