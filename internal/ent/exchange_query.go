...
func (_q *ExchangeQuery) Where(ps ...predicate.Exchange) *ExchangeQuery {
	_q.predicates = append(_q.predicates, ps...)
	return _q
}

// Limit the number of records to be returned by this query.
func (_q *ExchangeQuery) Limit(limit int) *ExchangeQuery {
	_q.ctx.Limit = &limit
	return _q
}

// Offset to start from.
func (_q *ExchangeQuery) Offset(offset int) *ExchangeQuery {
...
func (_q *ExchangeQuery) Unique(unique bool) *ExchangeQuery {
	_q.ctx.Unique = &unique
	return _q
}

// Order specifies how the records should be ordered.
func (_q *ExchangeQuery) Order(o ...exchange.OrderOption) *ExchangeQuery {
	_q.order = append(_q.order, o...)
	return _q
}

// QueryBots chains the current query on the "bots" edge.
func (_q *ExchangeQuery) QueryBots() *BotQuery {
...
func (_q *ExchangeQuery) First(ctx context.Context) (*Exchange, error) {
...
func (_q *ExchangeQuery) FirstX(ctx context.Context) *Exchange {
...
func (_q *ExchangeQuery) FirstID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *ExchangeQuery) FirstIDX(ctx context.Context) uuid.UUID {
...
func (_q *ExchangeQuery) Only(ctx context.Context) (*Exchange, error) {
...
func (_q *ExchangeQuery) OnlyX(ctx context.Context) *Exchange {
...
func (_q *ExchangeQuery) OnlyID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *ExchangeQuery) OnlyIDX(ctx context.Context) uuid.UUID {
...
func (_q *ExchangeQuery) All(ctx context.Context) ([]*Exchange, error) {
	ctx = setContextOp(ctx, _q.ctx, ent.OpQueryAll)
	if err := _q.prepareQuery(ctx); err != nil {
		return nil, err
	}
	qr := querierAll[[]*Exchange, *ExchangeQuery]()
	return withInterceptors[[]*Exchange](ctx, _q, qr, _q.inters)
}

// AllX is like All, but panics if an error occurs.
func (_q *ExchangeQuery) AllX(ctx context.Context) []*Exchange {
...
func (_q *ExchangeQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
	if _q.ctx.Unique == nil && _q.path != nil {
		_q.Unique(true)
	}
	ctx = setContextOp(ctx, _q.ctx, ent.OpQueryIDs)
	if err = _q.Select(exchange.FieldID).Scan(ctx, &ids); err != nil {
		return nil, err
	}
	return ids, nil
}
...
func (_q *ExchangeQuery) IDsX(ctx context.Context) []uuid.UUID {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *ExchangeQuery) Count(ctx context.Context) (int, error) {
	ctx = setContextOp(ctx, _q.ctx, ent.OpQueryCount)
	if err := _q.prepareQuery(ctx); err != nil {
		return 0, err
	}
	return withInterceptors[int](ctx, _q, querierCount[*ExchangeQuery](), _q.inters)
}

// CountX is like Count, but panics if an error occurs.
func (_q *ExchangeQuery) CountX(ctx context.Context) int {
...
func (_q *ExchangeQuery) Exist(ctx context.Context) (bool, error) {
...
func (_q *ExchangeQuery) ExistX(ctx context.Context) bool {
...
func (_q *ExchangeQuery) Clone() *ExchangeQuery {
	if _q == nil {
		return nil
	}
...
func (_q *ExchangeQuery) WithBots(opts ...func(*BotQuery)) *ExchangeQuery {
	query := (&BotClient{config: _q.config}).Query()
...
func (_q *ExchangeQuery) GroupBy(field string, fields ...string) *ExchangeGroupBy {
	...
	grbuild := &ExchangeGroupBy{build: _q}
...
func (_q *ExchangeQuery) Select(fields ...string) *ExchangeSelect {
	...
	sbuild := &ExchangeSelect{ExchangeQuery: _q}
...
func (_q *ExchangeQuery) Aggregate(fns ...AggregateFunc) *ExchangeSelect {
	return _q.Select().Aggregate(fns...)
}

func (_q *ExchangeQuery) prepareQuery(ctx context.Context) error {
...
func (_q *ExchangeQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Exchange, error) {
	var (
		nodes       = []*Exchange{}
		_spec       = _q.querySpec()
		loadedTypes = [1]bool{
	...
	_spec.Assign = func(columns []string, values []any) error {
		node := &Exchange{config: _q.config}
	...
	if query := _q.withBots; query != nil {
		if err := _q.loadBots(ctx, query, nodes,
			func(n *Exchange) { n.Edges.Bots = []*Bot{} },
			func(n *Exchange, e *Bot) { n.Edges.Bots = append(n.Edges.Bots, e) }); err != nil {
			return nil, err
		}
	}
...
func (_q *ExchangeQuery) loadBots(ctx context.Context, query *BotQuery, nodes []*Exchange, init func(*Exchange), assign func(*Exchange, *Bot)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(bot.FieldExchangeID)
	}
...
func (_q *ExchangeQuery) sqlCount(ctx context.Context) (int, error) {
	_spec := _q.querySpec()
	if len(_q.modifiers) > 0 {
		_spec.Modifiers = _q.modifiers
	}
...
func (_q *ExchangeQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(exchange.Table, exchange.Columns, sqlgraph.NewFieldSpec(exchange.FieldID, field.TypeUUID))
	_spec.From = _q.sql
...
func (_q *ExchangeQuery) sqlQuery(ctx context.Context) *sql.Selector {
...
func (_q *ExchangeQuery) WithNamedBots(name string, opts ...func(*BotQuery)) *ExchangeQuery {
	query := (&BotClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_g *ExchangeGroupBy) Aggregate(fns ...AggregateFunc) *ExchangeGroupBy {
	_g.fns = append(_g.fns, fns...)
	return _g
}

// Scan applies the selector query and scans the result into the given value.
func (_g *ExchangeGroupBy) Scan(ctx context.Context, v any) error {
	ctx = setContextOp(ctx, _g.build.ctx, ent.OpQueryGroupBy)
	if err := _g.build.prepareQuery(ctx); err != nil {
		return err
	}
	return scanWithInterceptors[*ExchangeQuery, *ExchangeGroupBy](ctx, _g.build, _g, _g.build.inters, v)
}

func (_g *ExchangeGroupBy) sqlScan(ctx context.Context, root *ExchangeQuery, v any) error {
...
func (_s *ExchangeSelect) Aggregate(fns ...AggregateFunc) *ExchangeSelect {
	_s.fns = append(_s.fns, fns...)
	return _s
}

// Scan applies the selector query and scans the result into the given value.
func (_s *ExchangeSelect) Scan(ctx context.Context, v any) error {
	ctx = setContextOp(ctx, _s.ctx, ent.OpQuerySelect)
	if err := _s.prepareQuery(ctx); err != nil {
		return err
	}
	return scanWithInterceptors[*ExchangeQuery, *ExchangeSelect](ctx, _s.ExchangeQuery, _s, _s.inters, v)
}

func (_s *ExchangeSelect) sqlScan(ctx context.Context, root *ExchangeQuery, v any) error {
