...
func (k *KubernetesRuntime) CreateBot(ctx context.Context, spec BotSpec) error {
...
func (k *KubernetesRuntime) GetContainerIP(ctx context.Context, botID string) (string, error) {
	return "", fmt.Errorf("kubernetes runtime is not yet supported")
}
