...
func (ec *executionContext) unmarshalInputCreateBacktestInput(ctx context.Context, obj any) (ent.CreateBacktestInput, error) {
	...
	fieldsInOrder := [...]string{"status", "config", "result", "containerID", "errorMessage", "createdAt", "updatedAt", "completedAt", "strategyID", "runnerID"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
...
func (ec *executionContext) unmarshalInputCreateBotInput(ctx context.Context, obj any) (ent.CreateBotInput, error) {
	...
	fieldsInOrder := [...]string{"name", "status", "mode", "containerID", "config", "freqtradeVersion", "lastSeenAt", "errorMessage", "createdAt", "updatedAt", "exchangeID", "strategyID", "runnerID", "tradeIDs", "metricsID"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
...
func (ec *executionContext) unmarshalInputCreateExchangeInput(ctx context.Context, obj any) (ent.CreateExchangeInput, error) {
	...
	fieldsInOrder := [...]string{"name", "config", "createdAt", "updatedAt", "botIDs"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
...
func (ec *executionContext) unmarshalInputUpdateBotInput(ctx context.Context, obj any) (ent.UpdateBotInput, error) {
	...
	fieldsInOrder := [...]string{"name", "status", "mode", "containerID", "clearContainerID", "config", "clearConfig", "freqtradeVersion", "lastSeenAt", "clearLastSeenAt", "errorMessage", "clearErrorMessage", "updatedAt", "exchangeID", "strategyID", "runnerID", "addTradeIDs", "removeTradeIDs", "clearTrades", "metricsID", "clearMetrics"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
...
func (ec *executionContext) unmarshalInputUpdateExchangeInput(ctx context.Context, obj any) (ent.UpdateExchangeInput, error) {
	...
	fieldsInOrder := [...]string{"name", "config", "clearConfig", "updatedAt", "addBotIDs", "removeBotIDs", "clearBots"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
