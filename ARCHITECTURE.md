# AnyTrade - Architectural Patterns & Guidelines
...
models:
  # Reuse ENT types
  Bot:
    model: anytrade/ent.Bot

  Exchange:
    model: anytrade/ent.Exchange

  Strategy:
    model: anytrade/ent.Strategy

  Backtest:
    model: anytrade/ent.Backtest

  HyperOpt:
    model: anytrade/ent.HyperOpt

  Trade:
    model: anytrade/ent.Trade

  # Reuse ENT enums
  BotStatus:
    model: anytrade/ent/bot.Status

  RuntimeType:
    model: anytrade/ent/bot.RuntimeType

  ExchangeType:
    model: anytrade/ent/exchange.Name

  # Connection types generated by ENT
  BotConnection:
    model: anytrade/ent.BotConnection

  StrategyConnection:
    model: anytrade/ent.StrategyConnection

# Autobind common types
autobind:
  - anytrade/ent
  - anytrade/ent/bot
  - anytrade/ent/exchange
  - anytrade/ent/strategy
  - anytrade/ent/backtest
  - anytrade/ent/hyperopt
  - anytrade/ent/trade
```
...
docker-build:
	...
	docker build -t anytrade/freqtrade:latest -f docker/freqtrade/Dockerfile .
	docker build -t anytrade/control-plane:latest -f docker/control-plane/Dockerfile .
